...
showWeatherData = (weatherData) => {
  ...
  let Wtype = weatherData.weather[0].main;
  ...
  document.getElementById('weather-type').innerText = Wtype;
  document.getElementById('temp').innerText = temp;
  document.getElementById('min-temp').innerText = tempMin;
  document.getElementById('max-temp').innerText = tempMax;
};
